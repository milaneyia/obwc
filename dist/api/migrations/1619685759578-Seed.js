...
exports.Seed1619685759578 = void 0;
class Seed1619685759578 {
    async up(queryRunner) {
        ...
        await queryRunner.query(`INSERT INTO contest (id, name, announcementAt, registrationStartedAt, registrationEndedAt) VALUES` +
        ...
        await queryRunner.query(`INSERT INTO round (id, contestId, submissionsStartedAt, submissionsEndedAt, judgingStartedAt, judgingEndedAt, resultsAt) VALUES` +
        ...
        await queryRunner.query(`INSERT INTO criteria (name, maxScore, judgingTypeId, contestId) VALUES ` +
            `('Expertise', 30, 1, 1),` +
            `('Cohesion', 30, 1, 1),` +
            `('Creativity', 30, 1, 1),` +
...
exports.Seed1619685759578 = Seed1619685759578;
